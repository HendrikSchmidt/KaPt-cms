...
export interface ApiPhilosophyPhilosophy extends Schema.SingleType {
  ...
  attributes: {
    Philosophie: Attribute.RichText &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    Biographies: Attribute.Component<'personal.biographie', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
